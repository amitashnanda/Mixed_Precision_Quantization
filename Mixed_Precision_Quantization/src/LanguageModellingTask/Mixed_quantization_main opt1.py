...
# Quant_LLM/Mixed_Precision_Quantization/src/correlation_based_quantization/canonical_analysis_sensitivites opt.py
from correlation_based_quantization.canonical_analysis_sensitivites_opt import layer_sensitivitites
#from Taylor_decomposition_based_quantization.TaylorSensitivies import layer_sensitivitites
# from pruning_based_quantization.DifferentpercentsparsitypruniningSensitivies import layer_sensitivitites

# print("layer_sensitivitites")
# print(layer_sensitivitites)
# layer_sensitivitites = {'layer_0': 0.00039987204094688034,'layer_1': 7.997440818940937e-05, 'layer_2': 7.997440818940937e-05,'layer_3':  7.997440818940937e-05,'layer_4': -0.00063979526551505,'layer_5': 0.00015994881637870773,'layer_6':3.998720409470469e-05,'layer_7':0.00015994881637870773,'layer_8':7.997440818940937e-05, 'layer_9': 7.997440818940937e-05, 'layer_10': 7.997440818940937e-05,'layer_11': 7.997440818940937e-05}
...
def main():
    # Initial setup
    # model_name =  'facebook/opt-1b' #'bert-base-uncased'
    device = torch.device("cuda:3" if torch.cuda.is_available() else "cpu")
    # device = torch.device("cpu")
    model_name = "facebook/opt-1.3b"  # Change this to 'facebook/opt-2.7b' for OPT-2
