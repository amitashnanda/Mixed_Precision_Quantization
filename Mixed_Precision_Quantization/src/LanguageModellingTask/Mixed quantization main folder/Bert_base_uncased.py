...
# from correlation_based_quantization.canonical_analysis_sensitivites_wikitextData4 import layer_sensitivitites
# from pruning_based_quantization.DifferentpercentsparsitypruniningSensitivies_bert_base_wikitextData4 import layer_sensitivitites
from Taylor_decomposition_based_quantization.TaylorSensitivies_bert_base_uncased_wikitextData4 import layer_sensitivitites
print(layer_sensitivitites)
# Adjust the path for your actual module for sensitivity import
# layer_sensitivitites = {'layer_0': 0.030194817285087994, 'layer_1': 0.01838246682327538, 'layer_2': 0.0174176005535136, 'layer_3': 0.0168829818572217, 'layer_4': 0.014919899531180225, 'layer_5': 0.015203604309760976, 'layer_6': 0.015328091711926728, 'layer_7': 0.014851043337643977, 'layer_8': 0.013731689375011569, 'layer_9': 0.012897667242808719, 'layer_10': 0.011585864264636037, 'layer_11': 0.013082330215691051, 'layer_12': 0.012286816912702947, 'layer_13': 0.011501158178333082, 'layer_14': 0.011953120509300419, 'layer_15': 0.011016554285525282, 'layer_16': 0.011055897487790678, 'layer_17': 0.010245042363551726, 'layer_18': 0.009465436743600009, 'layer_19': 0.008720866844179276, 'layer_20': 0.008912402416923038, 'layer_21': 0.009006845522402274, 'layer_22': 0.009833388885212457, 'layer_23': 0.009272677852518396}
...
def main():
    ...
    # p1 = compute_perplexity(model, dataloader, eval_iters=100)
    ...
    # print(f"Perplexity after quantization: {accuracy_after:.5f}")
    # accuracy_before = evaluate(model, dataloader, device)
    # print(f"Accuracy before quantization: {accuracy_before:.5f}")
    device = torch.device("cuda:3" if torch.cuda.is_available() else "cpu")
