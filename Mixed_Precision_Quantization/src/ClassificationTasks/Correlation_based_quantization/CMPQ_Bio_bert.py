...
with open(f'saved_data/layer_sensitivitites_biobert_{time_taken:.2f}.json', 'w') as f:
    json.dump(layer_sensitivitites, f)

print("Saved the layer sensitivitites to layer_sensitivitites_biobert.json")
