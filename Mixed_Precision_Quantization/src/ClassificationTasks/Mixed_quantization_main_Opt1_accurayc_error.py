...
def trasdain(model, dataloader, optimizer):
    model.train()
    total_loss = 0
    for batch in dataloader:
        ...
        loss = outputs.loss  # Make sure the model computes the loss
        ...
        if loss is not None:
            ...
            print("Loss not calculated, something might be wrong with input data or model configuration.")
...
def train(model, train_loader, optimizer):
    ...
    for epoch in range(15):  # number of epochs can be adjusted
...
# from Correlation_based_quantization.cmpq_opt_125m import layer_sensitivitites
...
# print(layer_sensitivitites)
#pmpq
# [0.017434420985284693, 0.007197696737044179, -0.012515994881637793, 0.007597568777991115, -0.01327575175943696, 0.0124760076775432, -0.006557901471529126, -0.00703774792066536, -0.0003998720409468248, 0.010676583493282155, 0.0013195777351248106, 0.01591490722968658]
#ccmq
#below are layer sensitivites for opt - 1.3b
